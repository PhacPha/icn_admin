document.addEventListener("DOMContentLoaded", function () {
  // เมื่อโหลดหน้าเว็บ ส่งข้อมูลเข้ามาที่ server (Page View Tracking)
  fetch("analytics.php", {
    method: "POST",
    headers: {
  ...
  if (window.innerWidth <= 768) {
    ...
    toggleBtn.className =
      "fixed top-4 left-4 z-50 p-2 bg-blue-500 text-white rounded-lg";
...
// เพิ่มในส่วนท้ายของไฟล์ (Message Detail & Reply Modal)
