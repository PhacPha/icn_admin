...
<main class="ml-64 p-6 w-full min-h-screen bg-white">
                    ...
                    <tbody>
                        <?php foreach ($GLOBALS['logos'] as $logo): ?>
                            <tr class="bg-white hover:bg-gray-100 transition-colors duration-200">
                                ...
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($logo['alt_text']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle">
                                    <div class="flex flex-col items-center gap-1">
                                        <button class="bg-blue-500 text-white p-2 rounded-lg hover:bg-blue-600 transition duration-300 ease-in-out"
                                        ...
                                        <button class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 transition duration-300 ease-in-out"
                ...
                <table class="service-table w-full text-center border-separate border border-gray-300">
                    ...
                    <tbody>
                        <?php foreach ($GLOBALS['services'] as $service): ?>
                            <tr class="bg-white hover:bg-gray-100 transition-colors duration-200">
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($service['id']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle">
                                ...
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($service['title']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($service['list_item1']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($service['list_item2']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($service['list_item3']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle">
                                    <div class="flex flex-col items-center gap-1">
                                        <button class="bg-blue-500 text-white p-2 rounded-lg hover:bg-blue-600 transition duration-300 ease-in-out"
                ...
                <table class="work-table w-full text-center border-separate border border-gray-300">
                    ...
                    <tbody>
                        <?php foreach ($GLOBALS['works'] as $work): ?>
                            <tr class="bg-white hover:bg-gray-100 transition-colors duration-200">
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($work['id']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle">
                                ...
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($work['title']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($work['list_item1']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($work['list_item2']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($work['list_item3']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle">
                                    <div class="flex flex-col items-center gap-1">
                                        <button class="bg-blue-500 text-white p-2 rounded-lg hover:bg-blue-600 transition duration-300 ease-in-out"
                ...
                <table class="testimonial-table w-full text-center border-separate border border-gray-300">
                    ...
                    <tbody>
                        <?php foreach ($GLOBALS['testimonials'] as $testimonial): ?>
                            <tr class="bg-white hover:bg-gray-100 transition-colors duration-200">
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($testimonial['id']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($testimonial['quote']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($testimonial['text']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($testimonial['author_name']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle"><?php echo htmlspecialchars($testimonial['author_location']); ?></td>
                                <td class="p-3 border border-gray-300 align-middle">
    ...
    <div id="add-logo-modal" role="dialog" aria-modal="true" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="bg-green-500 text-white p-2 rounded-lg hover:bg-green-600 transition duration-300 ease-in-out flex-1">เพิ่ม</button>
                    <button type="button" onclick="hideAddLogoModal()" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 transition duration-300 ease-in-out flex-1">ยกเลิก</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="edit-logo-modal" role="dialog" aria-modal="true" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="bg-green-500 text-white p-2 rounded-lg hover:bg-green-600 transition duration-300 ease-in-out flex-1">บันทึก</button>
                    <button type="button" onclick="hideEditLogoModal()" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 transition duration-300 ease-in-out flex-1">ยกเลิก</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <!-- Modal สำหรับลบโลโก้ -->
    <div id="delete-logo-modal" role="dialog" aria-modal="true" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="GET" action="">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 transition duration-300 ease-in-out flex-1">ลบ</button>
                    <button type="button" onclick="hideDeleteLogoModal()" class="bg-gray-500 text-white p-2 rounded-lg hover:bg-gray-600 transition duration-300 ease-in-out flex-1">ยกเลิก</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="add-service-modal" role="dialog" aria-modal="true" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="bg-green-500 text-white p-2 rounded-lg hover:bg-green-600 transition duration-300 ease-in-out flex-1">เพิ่ม</button>
                    <button type="button" onclick="hideAddServiceModal()" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 transition duration-300 ease-in-out flex-1">ยกเลิก</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="edit-service-modal" role="dialog" aria-modal="true" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="bg-green-500 text-white p-2 rounded-lg hover:bg-green-600 transition duration-300 ease-in-out flex-1">บันทึก</button>
                    <button type="button" onclick="hideEditServiceModal()" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 transition duration-300 ease-in-out flex-1">ยกเลิก</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="delete-service-modal" role="dialog" aria-modal="true" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="GET" action="">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 transition duration-300 ease-in-out flex-1">ลบ</button>
                    <button type="button" onclick="hideDeleteServiceModal()" class="bg-gray-500 text-white p-2 rounded-lg hover:bg-gray-600 transition duration-300 ease-in-out flex-1">ยกเลิก</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="add-work-modal" role="dialog" aria-modal="true" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="bg-green-500 text-white p-2 rounded-lg hover:bg-green-600 transition duration-300 ease-in-out flex-1">เพิ่ม</button>
                    <button type="button" onclick="hideAddWorkModal()" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 transition duration-300 ease-in-out flex-1">ยกเลิก</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="edit-work-modal" role="dialog" aria-modal="true" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="bg-green-500 text-white p-2 rounded-lg hover:bg-green-600 transition duration-300 ease-in-out flex-1">บันทึก</button>
                    <button type="button" onclick="hideEditWorkModal()" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 transition duration-300 ease-in-out flex-1">ยกเลิก</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <!-- Modal สำหรับลบผลงาน -->
    <div id="delete-work-modal" role="dialog" aria-modal="true" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="GET" action="">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 transition duration-300 ease-in-out flex-1">ลบ</button>
                    <button type="button" onclick="hideDeleteWorkModal()" class="bg-gray-500 text-white p-2 rounded-lg hover:bg-gray-600 transition duration-300 ease-in-out flex-1">ยกเลิก</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="add-testimonial-modal" role="dialog" aria-modal="true" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="bg-green-500 text-white p-2 rounded-lg hover:bg-green-600 transition duration-300 ease-in-out flex-1">เพิ่ม</button>
                    <button type="button" onclick="hideAddTestimonialModal()" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 transition duration-300 ease-in-out flex-1">ยกเลิก</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="edit-testimonial-modal" role="dialog" aria-modal="true" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="bg-green-500 text-white p-2 rounded-lg hover:bg-green-600 transition duration-300 ease-in-out flex-1">บันทึก</button>
                    <button type="button" onclick="hideEditTestimonialModal()" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 transition duration-300 ease-in-out flex-1">ยกเลิก</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="delete-testimonial-modal" role="dialog" aria-modal="true" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="GET" action="">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 transition duration-300 ease-in-out flex-1">ลบ</button>
                    <button type="button" onclick="hideDeleteTestimonialModal()" class="bg-gray-500 text-white p-2 rounded-lg hover:bg-gray-600 transition duration-300 ease-in-out flex-1">ยกเลิก</button>
                </div>
            </form>
        </div>
    </div>
