...
<main class="ml-64 p-6 w-full min-h-screen bg-white">
    ...
    <div class="card bg-white p-6 rounded-lg shadow-lg mb-6 animate__animated animate__fadeInUp">
        <div class="flex justify-between items-center mb-4">
            ...
            <button onclick="showAddLogoModal()"
                class="bg-gradient-to-r from-green-500 to-blue-500 text-white p-2 rounded-lg hover:from-green-600 hover:to-blue-600 transition duration-300 ease-in-out">
                เพิ่มโลโก้
            </button>
        </div>
